...
![[raw/Web Technical/DOM/attachments/Untitled.png]]
...
> [!important] In the DOM, all HTML elements are defined as 
> 
> ==**objects**==.
...
> [!important] The HTML DOM allows JavaScript to change the content of HTML elements.
...
> [!important] We can add
> 
> ==many== events to the same element, ==without overwriting== existing events, add events of ==different types== to the same element
...
> [!important] With the HTML DOM, you can navigate the
> 
> ==node tree== using ==node relationships==.

![[raw/Web Technical/DOM/attachments/Untitled 1.png]]
...
> [!important] ==**An HTMLCollection is NOT an array!**==
> 
