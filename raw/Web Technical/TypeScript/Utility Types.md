...
Constructs a type consisting of all properties of `Type` set to required. The opposite of [[Utility Types]]
...
Constructs a type by picking all properties from `Type` and then removing `Keys` (string literal or union of string literals). The opposite of [[Utility Types]].
