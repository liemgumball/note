...
Created time: June 25, 2024 3:27 PM
...
7. `box-sizing` in **CSS**
    ...
    It is used to determine the way of calculating the height and width of a element. It determines whether the border and padding will be included or not to calculate the height and width of the element. The common values are **`content-box`(*default)*** and **`border-box.`**
...
3. What is **DOM?**
    ...
    **DOM** stands for **Document Object Model,** it is a programming interface for web documents. It represents the page so that programs can change the document structure, style, and content. The **DOM** represents the document as **nodes** and **objects**; that way, programming languages can interact with the page.
    ...
    ![Untitled](Notion/Note/Front-end%20developer%20interview%20questions/Untitled.png)
