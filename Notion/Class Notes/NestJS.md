Created: March 15, 2025 2:32 PM
Class: Personal-project
Type: Back-end
Materials: https://youtu.be/sFnAHC9lLaw, https://docs.nestjs.com/
Reviewed: No
Edited: May 10, 2025 2:47 PM

# Introduce

[Documentation | NestJS - A progressive Node.js framework](https://docs.nestjs.com/)

> **NestJS** is a framework for building [NodeJS](NodeJS.md) server-side applications.
> 

Using progressive [JavaScript](JavaScript.md) with fully [TypeScript](TypeScript.md) supports and combines of **OOP** *(Object Oriented Programming)* and **FP** *(Functional Programming)*

# Decorator

[What is a Decorator, Really?](What%20is%20a%20Decorator.md)
...
![Example of “resume” resource](Notion/Class%20Notes/NestJS/image.png)
...
Providers in Nest are used to create services, factories, helpers and more that can be inject into a [Controllers](NestJS.md) 
...
More will be mentioned in [Dependency injection](NestJS.md).
...
Modules in **Nest** are singletons by default
...
Don’t create your dependency, let’s someone give it to you.
