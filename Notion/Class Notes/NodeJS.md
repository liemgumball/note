Created: February 15, 2024 3:46 PM
Class: Agility IO InternShip
Type: Back-end
Materials: https://www.w3schools.com/nodejs, https://nodejs.org/api/
Reviewed: No
...
[https://github.com/liemgumball/nodejs-practice](https://github.com/liemgumball/nodejs-practice)
...
<aside>
💡 The core APIs provided by **Node.js** that allow us to interact with the standard I/O, the file system, and the network stack.
...
[Index | Node.js v21.6.2 Documentation](https://nodejs.org/api/)
...
[File system | Node.js v21.6.2 Documentation](https://nodejs.org/api/fs.html)
...
<aside>
💡 **TCP** stands for ***Transmission Control Protocol***. **TCP** provides a standard that allows devices to communicate over a network.
...
[Net | Node.js v21.6.2 Documentation](https://nodejs.org/api/net.html)
...
<aside>
💡 **UDP** stands for ***User Datagram Protocol.* UDP** is a connectionless protocol. Unlike **TCP**, the protocol does not establish a connection before sending data. **UDP** is typically used for *video calling*, *gaming*, or *streaming*—because in these cases, minimizing delay is important.
...
[URL | Node.js v21.6.2 Documentation](https://nodejs.org/api/url.html)

---

## Using web protocol

[Web protocol with Node.js](Web%20protocol%20with%20Node%20js.md)

## Developing Node.js module

[Developing modules](Developing%20modules.md)

## Exploring Node.js web framework

[Express framework](Express%20framework.md)
...
[Working with SQL databases](Working%20with%20SQL%20databases.md)

[Working with NoSQL databases](Working%20with%20NoSQL%20databases.md)

## Persisting data

[Persisting data with Redis](Persisting%20data%20with%20Redis.md)
...
[Testing with Jest](Testing%20with%20Jest.md)

---

## Securing Node.js applications

[Node.js securing](Node%20js%20securing.md)
...
<aside>
💡 The term *microservices* is used to describe applications that have been built on the basis of the microservice architecture paradigm.
...
[Deploying Node.js microservices](Deploying%20Node%20js%20microservices.md)
...
1. **Node.js** exposes a debugging utility via the `--inspect` process flag, which enables us to debug and profile our **Node.js** processes using the **Browser DevTools** interface.
    ...
    ![Untitled](Notion/Class%20Notes/NodeJS/Untitled.png)
    
2. Observe that our `server.js` is showing up as a **Remote Target**
    
    ![Untitled](Notion/Class%20Notes/NodeJS/Untitled%201.png)
...
<aside>
💡 It’s the main difference between **Node.js** and some other web-server
...
2. **Asynchronous API functions**: These functions initiate an operation and then continue executing the program without waiting for the operation to complete. [What do you mean by **Asynchronous API**?](NodeJS.md) 
...
- **Node.js** prevents blocking code by utilizing an asynchronous, non-blocking I/O model, event loop, and callback functions, enabling efficient handling of multiple concurrent operations without halting the entire program.
    ...
    Here's an example how it works: [How **Node.js** handles file requests](NodeJS.md) 
    

### What is `Libuv`?

`Libuv` is a multi-platform **C** library that provides asynchronous I/O support *(file system operations, network requests, timers …)*, event loop, cross-platform supports, thread pools and other fundamental features for building networking applications. It serves as the core foundation for handling asynchronous operations in **Node.js**
...
![](https://miro.medium.com/v2/resize:fit:1400/1*7coLKNPemPd9o40PmUvuvQ.gif)
