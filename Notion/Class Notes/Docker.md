Created: February 29, 2024 9:57 AM
Class: Agility IO InternShip
Type: Back-end
Materials: https://youtu.be/3c-iBn73dDE, https://www.docker.com/
Reviewed: Yes
...
![Untitled](Notion/Class%20Notes/Docker/Untitled.png)

## Container

<aside>
💡 A way to packages application with all the necessary dependencies and configuration
It’s portable artifact which easily shared. 
It makes the development much more convenient

</aside>

![Untitled](Notion/Class%20Notes/Docker/Untitled%201.png)
...
<aside>
💡 The **Image** is the portable part which can be shared
...
![Untitled](Notion/Class%20Notes/Docker/Untitled%202.png)
...
Take an example that we create an application with [NodeJS](NodeJS.md), [MongoDB](MongoDB.md) and [**Mongo Express UI**](https://hub.docker.com/_/mongo-express)
...
![Untitled](Notion/Class%20Notes/Docker/Untitled%203.png)

<aside>
💡 And the Node.js application connect to the container network through the **Host PORT** `mongodb://username:password@localhost:<image-port>`

</aside>

<aside>
📌 If the Node.js application run in the same container with **MongoDB** and **Mongo-Express** to. The `uri` will be `mongodb://username:password@<container-name>`
