...
<aside>
📌 Always take certain precautions to ensure the application built in secure
...
2. We get warning that this **Express** version is not recommended for production
    ...
    ![Untitled](Notion/Class%20Notes/NodeJS/Node%20js%20securing/Untitled.png)
...
3. Run the below command to see details
    ...
    ![Untitled](Notion/Class%20Notes/NodeJS/Node%20js%20securing/Untitled%201.png)
...
4. Run to fix the vulnerabilities
    ...
    ![Untitled](Notion/Class%20Notes/NodeJS/Node%20js%20securing/Untitled%202.png)
...
<aside>
⚠️ **Passwords** should never be stored in plain text and should instead be stored in a hashed form.

</aside>

[`bcrypt`](https://www.npmjs.com/package/bcrypt) is a popular module that is used to hash passwords in [NodeJS](NodeJS.md) 
...
![Untitled](Notion/Class%20Notes/NodeJS/Node%20js%20securing/Untitled%204.png)
...
![Untitled](Notion/Class%20Notes/NodeJS/Node%20js%20securing/Untitled%205.png)
...
<aside>
💡 We can use **Node.js**'s `decodeURI()` method to decode encoded URIs
...
<aside>
💡 Browser security has improved significantly in recent years. It's very difficult to replicate a **CSRF** attack on any modern browser. However, as there are still many users on older browsers, it's important to understand how these
