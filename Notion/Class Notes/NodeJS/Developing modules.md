...
It is recommended to install ==**Node.js**== with _Node Version Manager_ (`nvm`). It is a tool that enables you to easily switch ==**Node.js**== versions on most ==Unix-like== platforms.
...
`npm` is the name of the _Command-Line Interface_ tool (==**CLI**==) bundled with ==**Node.js**== as the default package manager.
