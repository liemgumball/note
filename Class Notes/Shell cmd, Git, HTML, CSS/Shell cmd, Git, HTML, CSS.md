...
- Flash, Video & Audio
    ...
    ![[Class Notes/Shell cmd, Git, HTML, CSS/attachments/Untitled.png|Untitled.png]]
    
    ![[Class Notes/Shell cmd, Git, HTML, CSS/attachments/Untitled 1.png|Untitled 1.png]]
...
- FORM
    ...
    ![[Class Notes/Shell cmd, Git, HTML, CSS/attachments/Untitled 2.png|Untitled 2.png]]
    
    - styling submit button
    
    ![[Class Notes/Shell cmd, Git, HTML, CSS/attachments/Untitled 3.png|Untitled 3.png]]
    
    - styling fieldset & legend
    
    ![[Class Notes/Shell cmd, Git, HTML, CSS/attachments/Untitled 4.png]]
    
    - aligning form
    
    ![[Class Notes/Shell cmd, Git, HTML, CSS/attachments/Untitled 5.png]]
